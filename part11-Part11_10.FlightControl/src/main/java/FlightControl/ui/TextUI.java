//The user interface is separate from the application logic and the classes
//that represent the problem domain. In this example, the user 
//interface is stored in the package ui.
